...
namespace HelloRevitApplication.Commands
{
    ...
    class AutoAreaLoads:IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            Singleton.Instance.RevitData.Transaction.SetName("Auto AreaLoads");
            ...
            TaskDialog.Show("Thành công", "Tạo tải trọng vùng thành công");
            return Result.Succeeded;
        }

        public void PrepareData()
        {
            Singleton.Instance.RevitData.AreaLoads();
        }
    }
}
